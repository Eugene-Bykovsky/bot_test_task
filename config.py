...
# Словарь с описанием голосовых команд
voice_commands = {
    "gpt": "Рассказываю своей бабушке, что такое GPT.",
    "sql и nosql": "Максимально коротко объясняю разницу между SQL и NoSQL.",
    "история первой любви": "Придумал вымышленную историю первой любви.",
}
